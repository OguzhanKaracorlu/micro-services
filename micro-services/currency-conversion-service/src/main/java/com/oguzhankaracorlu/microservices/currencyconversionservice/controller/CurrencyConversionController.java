...
import com.oguzhankaracorlu.microservices.currencyconversionservice.util.CurrencyExchangeProxy;
...
public class CurrencyConversionController {
    ...
    @GetMapping("/currency-convers/from/{from}/to/{to}/quantity/{quantity}")
...
//        return new CurrencyConversion(currencyConversion.getId(), from, to, currencyConversion.getEnvironment(), currencyConversion.getConversionMultiple(), quantity, quantity.multiply(currencyConversion.getConversionMultiple()));
    ...
    @GetMapping("/currency-convers-feign/from/{from}/to/{to}/quantity/{quantity}")
